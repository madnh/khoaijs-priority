describe('KhoaiJS Priority', function () {
    ...
    describe('Static property of KhoaiJS', function () {
        it('Priority must be a static property of KhoaiJS if exists', function (cb) {
            if (window.hasOwnProperty('Khoai')) {
                chai_assert.property(Khoai, 'Priority');
                cb();
            } else {
                cb();
            }
        });
        it('Static property of KhoaiJS and standalone object of Priority must be same', function (cb) {
            if (window.hasOwnProperty('Khoai')) {
                chai_assert.strictEqual(Khoai.Priority, Priority);
                cb();
            } else {
                cb();
            }
